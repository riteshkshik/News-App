...
class healthNewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerViewFragment = view.findViewById(R.id.health_news_recyclerView)
        if (MainActivity.healthNewsData == null){
            CoroutineScope(Dispatchers.IO).launch { topHeadLinesNews(Constants.HEALTH) }
        }else showDataToRecyclerView(MainActivity.healthNewsData!!)
        return view
    }
    ...
    fun topHeadLinesNews(category: String) {
        ...
        call.enqueue(object : Callback<News> {
            override fun onResponse(call: Call<News>, response: Response<News>) {
                ...
                if (news != null) {
                    MainActivity.healthNewsData = news.articles
